...
#include "chatlogic.h"
#include "chatgui.h"
//#include "../../../../../../usr/include/c++/9/bits/unique_ptr.h"
    ...
    : wxScrolledWindow(parent, id)
{
    ...
    //_chatLogic is now a unique pointer. 
    // functions which take in raw pointer of chat logic should now accept chatlogic.get()
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    //delete _chatLogic;
    // TODO : TASK 1 - no need to explicitly delete this now since delete gets called with the unique ptr itself
