...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic; // TODO : TASK 1 declare unique pointer
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } // TODO : TASK 1 - return raw pointer from the unique pointer
